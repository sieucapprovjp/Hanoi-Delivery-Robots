...
- **`algorithms/`**: Nơi triển khai các thuật toán tìm đường và module điều phối (**Dispatching**) phân bổ nhiệm vụ cho Robot.
...
### 3.2. Logic Phân chia Nhiệm vụ (Task Allocation / Dispatching - `dispatch/allocation.py`)
